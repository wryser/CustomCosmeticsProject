...
[CustomEditor(typeof(HoldableDescriptor))]
//https://blog.theknightsofunity.com/use-customeditor-customize-script-inspector/

public class HoldableCustomWindow : Editor
{
    private SerializedProperty Name;
    private SerializedProperty Author;
    private SerializedProperty Description;
    private SerializedProperty lHandObject;
    private SerializedProperty rHandObject;
    ...
    private void OnEnable()
    {
        ...
        lHandObject = serializedObject.FindProperty("leftHandObject");
        rHandObject = serializedObject.FindProperty("rightHandObject");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(lHandObject, new GUIContent("Left Hand Holdable Object"));
        EditorGUILayout.PropertyField(rHandObject, new GUIContent("Right Hand Holdable Object"));
        EditorGUILayout.PropertyField(behaviours, new GUIContent("Custom Behaviours"));
    ...
    public static void ExportHoldable(GameObject obj, string path)
    {
        ...
        if (descriptor.gunEnabled == true)
        {
            ...
            GameObject tempBullet = contentsRoot.GetComponent<HoldableDescriptor>().bulletObject;
